...
export const SideBar: React.FC = () => {
  ...
  return (
    <div className=" relative flex h-[calc(100vh)] w-full max-w-[20rem] flex-col bg-slate-900 bg-clip-border p-4 text-gray-700 opacity-80 shadow-lg shadow-blue-gray-900/5">
      ...
      <nav className="md:flex min-w-[240px] hidden flex-col gap-1 p-2 font-sans text-base font-normal text-white">
        <div
          onClick={() => {
            navigate("/home");
          }}
          role="button"
          className="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-slate-950 hover:shadow-md hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-slate-950 focus:text-blue-gray-900 active:bg-slate-950 active:bg-opacity-80 active:text-blue-gray-900"
        >
      ...
      <nav className="flex gap-5 md:invisible flex-col md:p-2 font-sans text-base font-normal text-white">
        <svg
          role="button"
          onClick={() => {
            navigate("/home");
